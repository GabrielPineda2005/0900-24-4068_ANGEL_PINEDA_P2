...
public class menu {
    ...
    public static void RecepcionComputadora(Scanner scanner) {
        ...
        while (continuar) {
            try {
                ...
                // Guardar datos en archivo global
                try (BufferedWriter bw = new BufferedWriter(new FileWriter("historial_computadoras.txt", true))) {
    ...
    public static void InspeccionComputadora(Scanner scanner) {
        ...
        while (continuar) {
            ...
            System.out.println("3. Priorizar inspeccion de computador");
            ...
            switch (opcion) {
                case 1:
                    ...
                    System.out.println("¿La computadora es reparable? (s/n): ");
                    String respuesta = scanner.nextLine();
    ...
    public static void ReparacionComputadora(Scanner scanner) {
        ...
        while (continuar) {
            ...
            switch (opcion) {
                case 1: { // Reparar primera en la cola (FIFO)
                    ...
                    String computadora = cola.poll(); // saca la primera
                    String serviceTag = computadora.split("\\|")[0].trim();
                    procesarReparacion(computadora, serviceTag, scanner);
                    break;
                }

                case 2: { // Ver cola de reparación
                    Queue<String> cola = ManejadorColas.getReparacion();
                    if (cola.isEmpty()) {
                        System.out.println("No hay computadoras en la cola de reparación.");
                    } else {
                ...
                case 3: { // Reparación por Service Tag
                    Queue<String> cola = ManejadorColas.getReparacion();
                    if (cola.isEmpty()) {
                        System.out.println("No hay computadoras en la cola de reparación.");
                        break;
                    ...
                    cola.remove(computadora); // quitarla de la cola para procesar
    ...
    public static void ControldeCalidad(Scanner scanner) {
        ...
        while (continuar) {
            try {
                ...
                System.out.println("¡Favor ingresar datos correctamente!");
                scanner.nextLine();
            }
        }
    }
        ...
        while (continuar) {
            ...
            switch (opcion) {
                case 1: {
                    ...
                    String computadora = colaEntrega.poll(); // saca la primera
                    String serviceTag = computadora.split("\\|")[0].trim();
                    String fecha = java.time.LocalDate.now().toString();
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(archivoHistorial))) {
            ...
            while ((linea = br.readLine()) != null) {
                ...
                if (linea.startsWith("=== Registro inicial ===")) {
                    ...
                    // Cualquier otra línea que no encaje, la ignoramos o se puede manejar aquí
                }
            }
            if (currentTag != null && !buffer.isEmpty()) {
                datosIniciales.put(currentTag, new ArrayList<>(buffer));
